...
type TamiatUserService interface {
	...
	Create(tUserObj tamiat_user.TamiatUser) error
...
func (s DefaultTamiatUserService) Create(tUserObj tamiat_user.TamiatUser) error {
	return s.repo.Create(tUserObj)
}
func (s DefaultTamiatUserService) ReadAll() ([]tamiat_user.TamiatUser, error) {
	return s.repo.ReadAll()
}
func (s DefaultTamiatUserService) ReadUserByID(id int) error {
